...
for name, ACTION in pairs(IA_ACTIONS) do
    ACTION.id = name
    ACTION.str = STRINGS.ACTIONS[name] or "IA_ACTION"
    AddAction(ACTION)
end
...
for actiontype, actons in pairs(IA_COMPONENT_ACTIONS) do
